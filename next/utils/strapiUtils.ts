...
type PopulateConfigType = Record<string, Record<string, Record<string, boolean> | string[]>>

export const createStrapiUrl = (endpoint: string, config: PopulateConfigType) => {
